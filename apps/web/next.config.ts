...
const nextConfig: NextConfig = {
    ...
    transpilePackages: [
        ...
        '@xgen/feature-admin-agentflow-management-orchestrator',
        '@xgen/feature-admin-agentflow-management-view',
        '@xgen/feature-admin-agentflow-management-executor',
        '@xgen/feature-admin-agentflow-management-monitoring',
        '@xgen/feature-admin-agentflow-management-test',
        '@xgen/feature-admin-agentflow-management-log',
