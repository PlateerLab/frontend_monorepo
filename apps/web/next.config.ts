...
const nextConfig: NextConfig = {
    ...
    transpilePackages: [
        ...
        '@xgen/main-documents-orchestrator',
        '@xgen/main-documents-collections',
        '@xgen/main-documents-file-storage',
        '@xgen/main-documents-repositories',
        '@xgen/main-documents-db-connections',
