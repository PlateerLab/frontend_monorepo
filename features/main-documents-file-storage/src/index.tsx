...
// ─────────────────────────────────────────────────────────────
// DocumentFileStorage Component
// ─────────────────────────────────────────────────────────────

const DocumentFileStorage: React.FC<DocumentTabPluginProps> = () => {
  ...
  return (
    <div className="p-6 max-w-[1400px] mx-auto">
      <div className="flex items-center justify-between mb-6 flex-wrap gap-4">
        <Button>
          <PlusIcon />
          {t('documents.buttons.newStorage')}
        </Button>
...
export default DocumentFileStorage;

export const documentsFileStoragePlugin: DocumentTabPlugin = {
  id: 'file-storage',
  name: 'Document File Storage',
  tabLabelKey: 'documents.tabs.fileStorage',
  order: 2,
  component: DocumentFileStorage,
};
