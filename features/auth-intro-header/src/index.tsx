...
export function IntroHeader({ user, onLogout }: IntroductionHeaderProps) {
...
export const authIntroHeaderPlugin: IntroductionSectionPlugin = {
  id: 'auth-intro-header',
  name: 'Introduction Header',
  headerComponent: IntroHeader,
};

export default authIntroHeaderPlugin;
