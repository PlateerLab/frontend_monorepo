...
export const authIntroFeaturesPlugin: IntroductionSectionPlugin = {
  id: 'auth-intro-features',
  name: 'Introduction Features',
  featuresComponent: IntroFeatures,
};

export default authIntroFeaturesPlugin;
